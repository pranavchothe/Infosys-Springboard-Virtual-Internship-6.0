...
import '../dealer/dealer_screens/dealer_chat_screen.dart';
...
class ResultScreen extends StatelessWidget {
  ...
  Future<void> _printPdf(BuildContext context) async {
    ...
    final priceEstimation =
        Map<String, dynamic>.from(result["price_estimation"] ?? {});
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          _pdfSection("Price Estimation", [
          "Estimated Market Value: ${priceEstimation["estimated_market_value"] ?? "N/A"}",
          "Recommended Negotiation Price: ${priceEstimation["recommended_negotiation_price"] ?? "N/A"}",
          "Confidence: ${priceEstimation["confidence"] ?? "N/A"}",
          ]),
                      ...
                      SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _section("Price Estimation"),

                            _glassTile(
                              Icons.currency_rupee,
                              "Estimated Market Value",
                              priceEstimation["estimated_market_value"],
                            ),

                            _glassTile(
                              Icons.trending_down,
                              "Recommended Negotiation Price",
                              priceEstimation["recommended_negotiation_price"],
                            ),
